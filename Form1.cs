...
namespace WebcamCaptureApp
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                comboBoxWebcamL.Items.Add(deviceList.Name);
            }
            comboBoxWebcamL.SelectedIndex = 0;
        ...
        private void buttonStart_Click(object sender, EventArgs e)
        {
            ...
            videoSource = new VideoCaptureDevice(captureDevice[comboBoxWebcamL.SelectedIndex].MonikerString);
